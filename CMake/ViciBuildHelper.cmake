...
macro(DEFINE_OUT_DIRS)
	if(VICI_EDITOR)
		set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/Runtime/Editor")
		set(CMAKE_LIBRARY_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/Lib/Editor")
		set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/Lib/Editor")
	else()
		set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/Runtime/")
...
macro(DECL_MODULE MOD_NAME MOD_LOC)
	...
	if(VICI_EDITOR)
		set("${MOD_NAME}_BINARIES_LOC" "${CMAKE_SOURCE_DIR}Binaries/Runtime/Editor")
		set("${MOD_NAME}_LIB_LOC" "${CMAKE_SOURCE_DIR}Binaries/Lib/Editor")
	else()
		set("${MOD_NAME}_BINARIES_LOC" "${CMAKE_SOURCE_DIR}Binaries/Runtime")
		set("${MOD_NAME}_LIB_LOC" "${CMAKE_SOURCE_DIR}Binaries/Lib")
	endif()
...
macro(DECL_ENGINE_MODULE MOD_NAME MOD_LOC)
	...
	if(VICI_EDITOR)
		set("${MOD_NAME}_BINARIES_LOC" "${VICI_HOME}Binaries/Runtime/Editor")
		set("${MOD_NAME}_LIB_LOC" "${VICI_HOME}Binaries/Lib/Editor")
	else()
		set("${MOD_NAME}_BINARIES_LOC" "${VICI_HOME}Binaries/Runtime")
		set("${MOD_NAME}_LIB_LOC" "${VICI_HOME}Binaries/Lib")
	endif()
	# Append to module list
	_Internal_APPEND_MODULE(${MOD_NAME})
