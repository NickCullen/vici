...
macro(DEFINE_OUT_DIRS)
	if(VICI_EDITOR)
		set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Runtime/Editor")
		set(CMAKE_LIBRARY_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Lib/Editor")
		set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Lib/Editor")
	else()
		set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Runtime")
		set(CMAKE_LIBRARY_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Lib")
		set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Lib")
	endif()
...
macro(DECL_MODULE MOD_NAME MOD_LOC)
	...
	if(VICI_EDITOR)
		set("${MOD_NAME}_BINARIES_LOC" "${CMAKE_SOURCE_DIR}Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Runtime/Editor")
		set("${MOD_NAME}_LIB_LOC" "${CMAKE_SOURCE_DIR}Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Lib/Editor")
	else()
		set("${MOD_NAME}_BINARIES_LOC" "${CMAKE_SOURCE_DIR}Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Runtime")
		set("${MOD_NAME}_LIB_LOC" "${CMAKE_SOURCE_DIR}Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Lib")
	endif()
...
macro(DECL_ENGINE_MODULE MOD_NAME MOD_LOC)
	...
	if(VICI_EDITOR)
		set("${MOD_NAME}_BINARIES_LOC" "${VICI_HOME}Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Runtime/Editor")
		set("${MOD_NAME}_LIB_LOC" "${VICI_HOME}Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Lib/Editor")
	else()
		set("${MOD_NAME}_BINARIES_LOC" "${VICI_HOME}Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Runtime")
		set("${MOD_NAME}_LIB_LOC" "${VICI_HOME}Binaries/${VICI_TARGET_SYSTEM}/$<CONFIGURATION>/Lib")
	endif()
	# Append to module list
	_Internal_APPEND_MODULE(${MOD_NAME})
